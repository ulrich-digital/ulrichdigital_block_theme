...
define( 'UD_SETTINGS_VERSION', '0.1.2' );
...
require_once UD_SETTINGS_PATH . 'includes/options/editor-help/editor-help.php';
require_once UD_SETTINGS_PATH . 'includes/options/editor-inserter/editor-inserter.php';
